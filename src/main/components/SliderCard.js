...
function SliderCard({ name, location, rating, mess, img }) {
  return (
    <div className="card-container">
      <div className="top-card">
        <div className="left-top-card">
          <img src={require(`../../res/${img}`)} alt="img2"></img>
          <div className="details-card">
            <div className="details-card-1">{name}</div>
            <div className="details-card-2">{location}</div>
          </div>
        </div>
